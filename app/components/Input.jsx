...
export function Input({className = '', type, variant, ...props}) {
  const variants = {
    minisearch:
      'bg-transparent  border-b transition  -mb-px border-x-0 border-t-0 appearance-none px-2 py-1 focus:ring-transparent placeholder:opacity-20 placeholder:text-inherit',
  };
